...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "fanxiangyang"
  # s.authors            = { "fanxiangyang" => "fanxiangyang_heda@163.com" }
  ...
  s.source       = { :git => "https://github.com/fanxiangyang/FanKit.git", :tag => "0.0.1" }
  ...
  s.source_files  = "Classes", "Classes/FanKit/**/*.{h,m}"
  #s.exclude_files = "Classes/Exclude"

  s.public_header_files = "Classes/FanKit/**/*.h"
